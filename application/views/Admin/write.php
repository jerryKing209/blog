<div style="width:70%;display: inline-block;margin: 5px;">
...
<!--			</div>-->
    ...
    <!-- 配置文件 -->
    <script type="text/javascript" src="<?php echo base_url();?>public/ueditor2/ueditor.config.js"></script>
    <!-- 编辑器源码文件 -->
    <script type="text/javascript" src="<?php echo base_url();?>public/ueditor2/ueditor.all.js"></script>
    <!-- 实例化编辑器 -->
